...
export const SubstrateScoreResponseSchema = z
  .object({
    aoi: z
      .object({
    ...
    missing_indicators: z
      ...
      .describe("Indicators the scheme wanted but could not obtain for this period.")
      .optional(),
    period: z
    ...
    score: z
      .object({
        ...
        kind: z.literal("substrate_score").default("substrate_score"),
        method: z
          .object({
        ...
        value: z
          .object({
            band: z.enum(["low", "moderate", "elevated", "high", "extreme"]),
            caveats: z
              .array(z.string())
              .describe("What this score does not account for. Stated, not buried.")
              .optional(),
            components: z
              .array(
                z
                  .object({
                    ...
                    normalized: z
                      ...
                      .lte(1)
                      .describe(
                        "Value rescaled so 1.0 is the most fire-prone substrate condition.",
                      ),
                    rationale: z
                      .string()
                      .min(1)
                    ...
                    raw: z
                      .object({
                        claim_id: z
                          ...
                          .regex(new RegExp("^clm_[0-9A-HJKMNP-TV-Z]{26}$"))
                          .describe(
                            "Identifier for this exact claim. Pass to get_provenance to trace it.",
                          ),
                        confidence: z.number().gte(0).lte(1),
                        confidence_basis: z
                          .object({
                                ...
                                z
                                  .object({
                                    ...
                                    value: z
                                      ...
                                      .gte(0)
                                      .lte(1)
                                      .describe("Component score, 1.0 being ideal."),
                                    weight: z.number().gt(0).lte(1),
                                  })
                                  .strict()
                                  .describe(
                            ...
                            observation_count: z
                              ...
                              .gte(0)
                              .describe(
                                "Number of source observations composited into this value.",
                              ),
                            revisit_gap_days: z
                              .union([z.number().gte(0), z.null()])
                              .describe("Longest gap between contributing observations.")
                            ...
                            z
                              .object({
                                code: z
                                  .string()
                                  .min(1)
                                  .describe("Stable machine-readable flag code."),
                                confidence_penalty: z
                                  .number()
                                  .gte(0)
                                  .lte(1)
                                  .describe(
                                    "Multiplicative reduction this flag applied to the confidence score.",
                                  )
                                  .default(0),
                                constraint: z
                                  .string()
                                  .min(1)
                                  .describe(
                                    "Identifier of the constraint that produced this flag.",
                                  ),
                                expected: z
                                  .union([z.string(), z.null()])
                                  .describe("What the constraint required, in plain language.")
                        ...
                        method: z
                          .object({
                            citation: z
                              .string()
                              .min(1)
                              .describe("Full bibliographic citation for the method."),
                            doi: z.union([z.string(), z.null()]).default(null),
                            formula: z.union([z.string(), z.null()]).default(null),
                            name: z.string().min(1),
                            notes: z.union([z.string(), z.null()]).default(null),
                            ...
                            z
                              .object({
                                ...
                                asset_ids: z
                                  .array(z.string())
                                  .describe(
                                    "Scene, granule or asset identifiers consumed by this step.",
                                  )
                                  .optional(),
                                dataset_id: z
                                  .union([z.string(), z.null()])
                                ...
                                index: z
                                  ...
                                  .int()
                                  .gte(0)
                                  .describe("Position in the chain, 0 first."),
                                kind: z
                                  .enum(["observation", "processing", "validation"])
                                  .describe(
                                    "What a provenance step represents.\n\nA well-formed chain starts with at least one ``observation`` and ends with a\n``validation``. Everything between is ``processing``.",
                                ...
                                parameters: z
                                  .record(z.string(), z.any())
                                  .describe(
                                    "Every parameter that affects the numeric output of this step.",
                                  )
                                  .optional(),
                                pipeline_version: z.string(),
                                processed_at: z
                                  ...
                                  .describe("When this step ran."),
                                resolution_m: z.union([z.number().gt(0), z.null()]).default(null),
                                software: z
                                  .union([z.string(), z.null()])
                                  .describe(
                                    "Library and version doing the work, e.g. 'rasterio 1.4.3'.",
                                  )
                                  .default(null),
                                source: z
                                  .union([z.string(), z.null()])
                                ...
                                spatial_ref: z
                                  .string()
                                  .describe(
                                    "CRS of this step's output, as an authority code, e.g. 'EPSG:32610'.",
                                  ),
                              })
                              .strict()
                              .describe(
                        ...
                        unit: z
                          .string()
                          .min(1)
                          .describe("Unit of the value. 'index' for unitless ratios."),
                        validation_status: z
                          .enum(["validated", "flagged"])
                          .describe(
                            "The subset of :class:`ValidationStatus` a served value is allowed to carry.\n\n``rejected`` is deliberately absent. A rejected value is never served as an answer,\nand this enum is what makes that a type error rather than a convention.",
            ...
            weighting_scheme: z
              .string()
              .min(1)
              .describe("Named, versioned weighting used, e.g. 'gaia-wildfire-v1'."),
          })
          .strict()
          .describe(
      ...
      .strict()
      .describe("The substrate score, served under the same guarantees as any other number."),
  })
  .strict();
export type SubstrateScoreResponse = z.infer<typeof SubstrateScoreResponseSchema>;
