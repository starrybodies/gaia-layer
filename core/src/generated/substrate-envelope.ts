...
export const SubstrateEnvelopeSchema = z
  .object({
    claim_id: z
      .string()
    ...
    geometry_hash: z.string().min(8).describe("Stable hash of the geometry this value describes."),
...
export type SubstrateEnvelope = z.infer<typeof SubstrateEnvelopeSchema>;
