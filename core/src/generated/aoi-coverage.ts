...
export const AoiCoverageSchema = z
  .object({
    ...
    last_ingested_at: z.union([z.string().datetime({ offset: true }), z.null()]).default(null),
    name: z.string(),
  })
  .strict();
export type AoiCoverage = z.infer<typeof AoiCoverageSchema>;
