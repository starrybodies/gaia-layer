...
export const EcologicalStateResponseSchema = z
  .object({
    aoi: z
      .object({
    ...
    indicators: z
      .array(
        z
          ...
          .strict()
          .describe("A single scalar indicator value for a geometry over a period."),
      )
      .describe("One envelope per available indicator, period-aggregated."),
    period: z
      .object({ end: z.string().date(), start: z.string().date() })
      .strict()
    ...
    rejected: z
      ...
      .describe(
        "Indicators that were computed but failed validation. Reported so their absence is visible rather than silent.",
      )
      .optional(),
    summary: z
      .string()
      .describe(
        "Plain-language summary rendered from the validated numbers by a deterministic template. Never model-generated — see docs/whitepaper.md, lesson 2.",
      ),
    trends: z
      .array(
        z
          .object({
            ...
            kind: z.literal("trend").default("trend"),
            method: z
              .object({
                citation: z.string().min(1).describe("Full bibliographic citation for the method."),
                doi: z.union([z.string(), z.null()]).default(null),
            ...
            value: z
              .object({
                ...
                slope_per_month: z
                  .number()
                  .describe("Ordinary least squares slope, units per month."),
              })
              .strict()
              .describe(
          ...
          .strict()
          .describe("A trend in one indicator over a period."),
      )
      .describe("Per-indicator trend across the period.")
      .optional(),
  })
  .strict()
  .describe("Validated ecological state for a geometry over a period.");
export type EcologicalStateResponse = z.infer<typeof EcologicalStateResponseSchema>;
