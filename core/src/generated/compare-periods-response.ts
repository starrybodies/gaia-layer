...
export const ComparePeriodsResponseSchema = z
  .object({
    aoi: z
      .object({
    ...
    comparisons: z.array(
      z
        .object({
          delta: z.number().describe("period_b minus period_a, in the indicator's unit."),
          indicator: z
            .enum([
              "ndvi",
              "ndmi",
          ...
          p_value: z.union([z.number().gte(0).lte(1), z.null()]).default(null),
          percent_change: z
            .union([z.number(), z.null()])
            .describe("Omitted when the period A value is at or near zero.")
            .default(null),
          period_a: z
            .object({
              claim_id: z
          ...
          period_b: z
            ...
            .strict()
            .describe("A single scalar indicator value for a geometry over a period."),
          significance_method: z
            .string()
            .describe("How significance was decided, e.g. 'welch_t_test_alpha_0.05'."),
    ...
    period_b: z
      ...
      .strict()
      .describe("Inclusive date range. The layer works in whole days; sub-daily is out of scope."),
    summary: z.string().describe("Deterministic template over the comparisons above."),
  })
  .strict();
